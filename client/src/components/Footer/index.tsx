    ...
    >
      <div className="mx-auto flex max-w-7xl flex-col items-center px-5 py-3 sm:flex-row">
        ...
        <span className="mt-4 inline-flex justify-center sm:ml-auto sm:mt-0 sm:justify-start">
          ...
          <a
            href="https://www.linkedin.com/in/leonardocsdias/"
          ...
          <a
            href="https://github.com/leocarlos-dias"
            className="ml-3 text-gray-400"
            target="_blank"
            rel="noopener noreferrer"
          >
